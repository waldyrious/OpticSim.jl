@time @testset "Intersection" begin
    ...
    @time @testset "Spherical Cap" begin
    ...
    @time @testset "BoundingBox" begin
    ...
    @time @testset "ThinGrating" begin
